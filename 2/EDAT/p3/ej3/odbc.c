...
/*
ERRORCITOS IMPORTANTES
1.malloc es SQLAllocHandle -> stmt
2.despues, consulta con SQLExecDirect: recibe una cadena query que se van componiendo dinamicamente
  2.1: despues del sprintf de la consulta, hacer un printf de la consulta y probarla en pgadmin
  (porque a veces no peta pero no funciona)
3.despues, acceder al contenido con SQLGetData, SQLBindCol, etc.
4.hacer un SQLCloseCursor para que 2 y 3 funcionen
5.free es SQLFreeHandle
*/
